...
| HackList Custom position | Roblox adaptation | Left and Right remain authoritative; Custom drags only from visible glyph bounds, persists coordinates and never adds an input shield over windows. |
