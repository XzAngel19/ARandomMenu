...
| HackList Custom position | Roblox adaptation | Left and Right remain authoritative on every device; Custom lets the player drag and persist the list while the menu is open. |
