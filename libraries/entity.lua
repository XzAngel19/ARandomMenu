...
entitylib.getSort = function(entitysettings)
	local sort = entitysettings.Sort or function(a, b)
		return a.Magnitude < b.Magnitude
	end
	if entitysettings.Priority ~= 'Players' and entitysettings.Priority ~= 'NPCs' then
		return sort
	end

	local players = entitysettings.Priority == 'Players'
	return function(a, b)
		if (a.Entity.Player ~= nil) ~= (b.Entity.Player ~= nil) then
			return (a.Entity.Player ~= nil) == players
		end
		return sort(a, b)
	end
end
